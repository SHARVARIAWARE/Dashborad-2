...
df=pd.read_excel("C:\\Users\\admin\\Downloads\\PMFBY Taluka wise 2018-2023.xlsx")
def header_page():
...
page = st.sidebar.selectbox('Select Analysis', ['header_page', 'Year Wise Analysis', 'Taluka Wise Analysis'])

if page == 'Year Wise Analysis':
    Year_Wise_Analysis()
elif page == 'Taluka Wise Analysis':
